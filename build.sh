...
: ${MCSERVER:="E:/SpigotMC/Server1"}

SPIGOT="$MCSERVER"/spigot.jar

# Make sure that the SPIGOT jar
# exists and is readable
if [ ! -r $SPIGOT ]; then
    echo "$SPIGOT doesn't seem to exist.  Make sure you have SPIGOT.jar installed at $MCSERVER and run again.  If your server is not at $MCSERVER, set your MCSERVER environment variable to point to the correct directory."
    exit 1
fi
